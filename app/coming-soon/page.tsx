    ...
    <div className="flex-1 flex flex-col relative px-8">
      ...
      <section className="mb-10">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-bold">Coming Soon Videos <span className="text-purple-400">•</span></h3>
          ...
          {featuredContent.videos.slice(0, 3).map((video, idx) => (
            <ContentCard
              ...
              subtitle={
                ...
                ` • Coming ${new Date(video.release_date || '').toLocaleDateString()}`
              }
      ...
      {/* Coming Soon Audio Section */}
      <section className="mb-10">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-bold">Coming Soon Audio <span className="text-purple-400">•</span></h3>
          <Link href="#" className="text-purple-400 hover:underline">See All</Link>
        </div>
        <div className="flex space-x-6 overflow-x-auto pb-2">
          {featuredContent.audio.slice(0, 3).map((audio, idx) => (
            <ContentCard
              ...
              subtitle={
                ...
                ` • Coming ${new Date(audio.release_date || '').toLocaleDateString()}`
              }
              actionLabel="Reminder"
              author={audio.author ? {
      ...
      <section className="mb-10">
        <div className="flex items-center justify-between mb-4">
          <h3 className="text-xl font-bold">Coming Soon Articles <span className="text-purple-400">•</span></h3>
          <Link href="#" className="text-purple-400 hover:underline">See All</Link>
        </div>
        <div className="flex space-x-6 overflow-x-auto pb-2">
          {featuredContent.articles.slice(0, 3).map((article, idx) => (
            <ContentCard
              ...
              subtitle={
                ...
                ` • Coming ${new Date(article.release_date || '').toLocaleDateString()}`
              }
              actionLabel="Reminder"
